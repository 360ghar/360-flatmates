...
/// next page. When [rows] is missing (or null), returns an empty list with
...
({List<T> items, String? nextCursor, bool hasMore}) parsePagedEnvelope<T>(
  ...
  final data = envelope == null ? const <String, dynamic>{} : envelope;
  ...
  final nextCursor = rawNext == null ? null : rawNext.toString();
